...
export const FAQAccordionItem = (props: FAQAccordionItemProps) => {
  ...
  return (
    ...
    //   <AccordionItem value={`${index}`} className='group'>
    ...
    // </div>
    <AccordionItem value={`${index}`} className='group'>
      <div className='group-data-[state=open]:from-gradient-from group-data-[state=open]:to-gradient-to relative rounded-2xl p-[2px] transition-all group-data-[state=open]:bg-gradient-to-r'>
        <div className='rounded-[14px] bg-neutral-500 px-4 py-4 md:px-6'>
          <AccordionTrigger className='text-md-semibold md:text-xl-semibold'>
            {question}
          </AccordionTrigger>
          <AccordionContent className='text-sm-regular md:text-md-regular text-neutral-200'>
